...
describe('announcements', () => {
  ...
  it('publishes v0.5.3 before the stable v0.5.2, v0.5.1, v0.5.0, v0.4.3, v0.4.2 and v0.4.1 announcements', () => {
    expect(announcements[0]).toMatchObject({
      id: '2026-07-24-v053-effect-damage-and-spectator-exit',
      version: 'v0.5.3',
      title: 'v0.5.3：效果伤害结算与观战离场优化',
    });
    expect(announcements[1]).toMatchObject({
      id: '2026-07-23-v052-damage-board-and-art',
      version: 'v0.5.2',
      title: 'v0.5.2：伤害规则、棋盘交互与角色美术更新',
    });
