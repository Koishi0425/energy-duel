...
describe('announcements', () => {
  ...
  it('publishes v0.5.2 before the stable v0.5.1, v0.5.0, v0.4.3, v0.4.2 and v0.4.1 announcements', () => {
    ...
    expect(announcements[5].sections.map((section) => section.heading)).toEqual([
      '伤害与防御体系',
      '3 级攻击回溯即死',
      '星神正式开放',
      '内卫正式加入',
