...
export const ruleSections: GuideSection[] = [
  ...
  },
  {
    ...
    points: [
      '效果等级相等时双方附带效果都成功；效果等级不同时仅较高一方的附带效果成功。该结果不决定伤害。',
  ...
  },
  {
    ...
    points: [
      ...
      '永久房主离开会销毁房间；其他存活玩家在对局中永久离开会结束本局。已淘汰玩家可以自行离场，当前对局和棋盘不会因此改变。',
...
export const glossaryEntries: GlossaryEntry[] = [
  { id: 'effect-level', term: '效果等级', definition: '只决定招式附带效果是否成功。同级时双方成功，不同时仅较高一方成功；该结果不决定伤害。' },
